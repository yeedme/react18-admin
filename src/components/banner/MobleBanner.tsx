...
interface Props {
  setMobleBannerShow: (show: boolean) => void;
  mobleBannerShow:boolean
}

export default function MobleBanner({ setMobleBannerShow,mobleBannerShow }: Props) {
  const navigate = useNavigate();

  function setMobleBannerShowColose(page: string) {
    setMobleBannerShow(false);
    navigate(page);
  ...
  return (
    <div
      className={`${ mobleBannerShow ? " " : " hidden " }+" flex  w-screen h-screen z-50 bg-black bg-opacity-80 fixed items-center justify-center "`}
      onClick={() =>  setMobleBannerShow(false)}
    >
      <div className="grid grid-cols-2  grid-rows-2 gap-8 opacity-100">
        <div
          className="w-24 h-24 bg-white rounded-md"
          onClick={() => setMobleBannerShowColose("dashboard")}
        >
          {/* --- logoSvg--- */}
          <svg
          ...
          <div className="h-full text-center text-white text-xl">数据面板</div>
        </div>
        <div
          className="w-24 h-24 bg-white rounded-md"
          onClick={() => setMobleBannerShowColose("home")}
        >
          {/* --- logoSvg--- */}
          <svg
            viewBox="0 0 1024 1024"
        ...
        <div
          className="w-24 h-24 bg-white rounded-md"
          onClick={() => setMobleBannerShowColose("order")}
        >
          {/* --- logoSvg--- */}
          <svg
            viewBox="0 0 1024 1024"
