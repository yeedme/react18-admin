...
export default function LoginOrRegistered() {
  ...
  return (
    <>
    <div className='flex_Jcenter_Acenter LoginOrRegistered'>
      <div alt="bgImg"  className=' left' />

      <div className='right'>
       
       <div className='LoginOrRegistered_Nav flex_JSpaceBetween_AflexEnd'>
          <div onClick={()=>setPage("login")} className={page==='login'?'selectDiv':""}>登入</div>
          <div onClick={()=>setPage("registered")} className={page==='login'?"":'selectDiv'}>注册</div>
        </div>
